...
(add-to-list 'load-path "~/.emacs.d/github/codeium/codeium.el")
...
(custom-set-faces
 ...
 '(org-link ((t (:inherit link :foreground "#81a2be" :underline nil :slant italic :weight semi-bold)))))
